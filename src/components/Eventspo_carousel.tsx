        ...
        <div>
            ...
            <div ref={detailedevent} className={styles.event_detailcont}>
                <div className={styles.event_detailcont1}>
                    ...
                    <div className={styles.display_mobile_img_e}>
                        <Image
...
const products = [
    {
        ...
        description:
            "The club took the initiative to introduce and make individuals perfect in C language through the workshop. Through this workshop, beginners were able to start their journey in C. 3rd, and 4th-year students were able to cover the basics, which helped them with placement preparation.",
        participants: "100",
    ...
    },
    {
        ...
        description:
            "The event's goal was to inform participants about the use of augmented reality using Snapchat. This would help them learn new concepts regarding augmented reality and implement them practically. CODEX collaborated with GitHub Community GITAM to organize this event.",
        participants: "100",
...

    {
        ...
        description:
            "The objective of the conference was to educate the participants about competitive programming and the complexity of real-world topics. The goal of the event was to improve the attendees' logical reasoning and programming abilities.",
        participants: "100",
